...
parser.add_argument("--source_id", nargs=1, help="ID emisor fichero", metavar=('id_usuario'))
parser.add_argument("--dest_id", nargs=1, help="ID receptor fichero", metavar=('id_usuario'))
